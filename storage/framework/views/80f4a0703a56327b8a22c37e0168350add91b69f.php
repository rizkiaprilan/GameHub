                    ...
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item active"><a class="nav-link" href="<?php echo e(route('aboutus')); ?>">Fortnite</a></li>
...
<!-- -->
        ...
        <section class="features_area">
            <div class="section_title text-center">
                <h2>League of Legends Courses</h2>
            </div>
            <div class="row m0">

                <div class="col-md-4 features_item">
                    <img src="image/lolrole.jpg" alt="savage" width="175px" height="175px"
                    class="center"><br>
                    <h3 style="text-align:center">Role Courses</h3>
                    <p>Each role has a position on the map, and an important part to play</p> <br>
                    <a href="#" class="btn_hover view_btn">Courses</a>
                </div>

                <div class="col-md-4 features_item">
                    <img src="image/lolitem.jpg" alt="savage" width="175px" height="175px"
                    class="center"><br>
                    <h3 style="text-align:center">Items Courses</h3>
                    <p>Learn About The Best Items Build</p> <br> <br>
                    <a href="#" class="btn_hover view_btn">Courses</a>
                </div>

                <div class="col-md-4 features_item">
                    <img src="image/lolteam.jpg" alt="savage" width="175px" height="175px"
                    class="center"><br>
                    <h3 style="text-align:center">Team Fight Tactics</h3>
                    <p>Overcome and outlast your opponents by building a team of League of Legends champions that fight on your behalf.
                    </p> <br> <br>
                    <a href="#" class="btn_hover view_btn">Courses</a>
                </div>
...
<?php /**PATH D:\Laravel Project\GameHub\resources\views/Games/leagueoflegends.blade.php ENDPATH**/ ?>