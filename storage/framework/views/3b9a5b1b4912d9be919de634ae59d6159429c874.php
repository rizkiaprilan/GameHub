        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                <ul class="nav navbar-nav menu_nav ml-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="<?php echo e(route('aboutus')); ?>">About Us</a></li>
                    <!-- <li class="nav-item submenu dropdown">
...
<?php /**PATH D:\Laravel Project\GameHub\resources\views/aboutus.blade.php ENDPATH**/ ?>