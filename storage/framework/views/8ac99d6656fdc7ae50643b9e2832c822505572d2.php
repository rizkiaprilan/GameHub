        ...
        <section class="features_area">
            ...
            <div class="row m0">
                <div class="col-md-3 features_item">
                    <img src="image/csgospam.jpg" alt="savage" width="150px" height="150px"
                         style="text-align:center" class="margin">
                    <h3 style="text-align:center">Build Courses</h3>
                    <p>Learn How To Spaming in CS-GO</p> <br>
                    <a href="#" class="btn_hover view_btn">Courses</a>
                </div>
                <div class="col-md-3 features_item">
                    <img src="image/csgoweapon.png" alt="savage" width="150px" height="150px">
                    <h3 style="text-align:center">Weapon</h3>
                    <p>Learn About the Best Weapons for Buy and Efficiency</p> <br> <br>
                    <a href="#" class="btn_hover view_btn">Courses</a>
                </div>
                <div class="col-md-3 features_item">
                    <img src="image/csgoposition.jpg" alt="savage" width="150px" height="150px">
                    <h3 style="text-align:center">Positioning Courses</h3>
                    <p>Being able to Move Quickly and Efficiently</p> <br> <br>
                    <a href="#" class="btn_hover view_btn">Courses</a>
                </div>
                <div class="col-md-3 features_item">
                    <img src="image/csgoaim.jpg" alt="savage" width="150px" height="150px">
                    <h3 style="text-align:center">Shot On Target</h3>
                    <p>Learn How To Aim in CS-GO</p> <br>
                    <a href="#" class="btn_hover view_btn">Courses</a>
                </div>
...
<?php /**PATH D:\Laravel Project\GameHub\resources\views/Games/CS.blade.php ENDPATH**/ ?>