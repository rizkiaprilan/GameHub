        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                <ul class="nav navbar-nav menu_nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('aboutus')); ?>">About Us</a></li>
                    <!-- <li class="nav-item submenu dropdown">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="<?php echo e(route('contact')); ?>">Contact</a></li>
                </ul>
    ...
    <div class="container">
        <div class="page-cover text-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo e(route('contact')); ?>">Contact Us</a></li>
            </ol>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <ul class="list_style">
                                <li><a href="<?php echo e(route('fortnite')); ?>">Fortnite</a></li>
...
<?php /**PATH D:\Laravel Project\GameHub\resources\views/contact.blade.php ENDPATH**/ ?>